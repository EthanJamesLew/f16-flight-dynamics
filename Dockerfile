...
RUN apt-get --no-install-recommends update &&\
    apt-get --no-install-recommends install -yq git=1:2.30.2-1ubuntu1 curl=7.74.0-1ubuntu2.3 &&\
    apt-get --no-install-recommends install -yq python3=3.9.4-1 python3-pip=20.3.4-1ubuntu2 &&\
    apt-get --no-install-recommends install -yq libboost1.74-all-dev=1.74.0-8ubuntu2 gcc-8=8.4.0-7ubuntu3 g++-8=8.4.0-7ubuntu3 &&\
    apt-get --no-install-recommends install -yq graphviz=2.42.2-4build2 &&\
    apt-get clean &&\
